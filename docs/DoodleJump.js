...
// include: C:\Users\CURRRO~1\AppData\Local\Temp\tmpny0rjvwf.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'DoodleJump.data';
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_DoodleJump.data');
      }
      Module['addRunDependency']('datafile_DoodleJump.data');
    ...
    loadPackage({"files": [{"filename": "/assets/arial.ttf", "start": 0, "end": 1016724}, {"filename": "/assets/background.png", "start": 1016724, "end": 1061432}, {"filename": "/assets/doodle.png", "start": 1061432, "end": 1532867}, {"filename": "/assets/platform.png", "start": 1532867, "end": 1571550}], "remote_package_size": 1571550});

  })();

// end include: C:\Users\CURRRO~1\AppData\Local\Temp\tmpny0rjvwf.js
// include: C:\Users\CURRRO~1\AppData\Local\Temp\tmpdzqt4ih0.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\CURRRO~1\AppData\Local\Temp\tmpdzqt4ih0.js
// include: C:\Users\CURRRO~1\AppData\Local\Temp\tmp60oalx1q.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\CURRRO~1\AppData\Local\Temp\tmp60oalx1q.js
...
function findWasmBinary() {
  return locateFile('DoodleJump.wasm');
}
...
var ASM_CONSTS = {
  389844: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 390059: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 390206: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 390440: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL2.audioContext); } } } return SDL2.audioContext === undefined ? -1 : 0; },  
 390992: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
